...
namespace Wg_backend_api.Controllers.GameControllers
{
    ...
    public class ProductionSharesController : Controller
    {
        ...
        public ProductionSharesController(IGameDbContextFactory gameDbFactory)
        {
            _gameDbContextFactory = gameDbFactory;

            string schema = HttpContext.Session.GetString("Schema") ?? throw new ArgumentNullException("Schema");
