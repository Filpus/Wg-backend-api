...
CREATE TABLE modifiers (
    ...
    effects JSONB NOT NULL,                     -- opis efektu / warunki w formacie JSON
...
CREATE TABLE default_schema."accessToUnits" (  
   ...
   CONSTRAINT "FK_accessToUnits_nations_fk_Nations" FOREIGN KEY ("fk_Nation") REFERENCES default_schema.nations (id) ON DELETE CASCADE,  
