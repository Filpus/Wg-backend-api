...
CREATE TABLE default_schema."accessToUnits" (
    ...
    CONSTRAINT "FK_accessToUnits_players_fk_Users" FOREIGN KEY ("fk_Users") REFERENCES default_schema.players (id) ON DELETE CASCADE,
...
CREATE INDEX "IX_accessToUnits_fk_Users" ON default_schema."accessToUnits" ("fk_Users");
